...
输入法圈子人很少，而这个工具的用户更少。设计程序时要优先考虑熟练用户：
...
项目使用 UnoCSS 和 ElementPlus 组件库。视觉设计上模仿它们。多采用线条或背景色分割板块，而非留白。

英文字母和数字默认使用 JetBrains Mono 等宽字体。这个项目里经常说“按下x键”“码长为2.718”，这些信息最好用等宽字体，避免歧义。如果出现了大段英文，才使用 MiSans 字体。中文部分使用小米的 MiSans，它免费、质量高、含有 87887 个汉字（GB18030-2022）。
